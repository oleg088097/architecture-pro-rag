...
### Бот: [task4/bot.py](task4/bot.py)
Необходимы переменные среды TG_BOT_TOKEN
...
### Бот: [task5/bot.py](task5/bot.py)
Необходимы переменные среды TG_BOT_TOKEN, YC_API_KEY
